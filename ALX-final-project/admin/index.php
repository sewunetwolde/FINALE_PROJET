...
$query = "SELECT * FROM home,section_control,social_media,about,contact,site_background,seo,service,admin";
...
<!-- Navbar -->
<nav class="main-header navbar navbar-expand navbar-white navbar-light"style="background-color: #b3e2ef;">
  <!-- Left navbar links -->
  <ul class="navbar-nav">
    <li class="nav-item">
...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #68c5e0;font-family:'Times New Roman', Times, serif;">
  <!-- Brand Logo -->
  <!-- <a href="index3.html" class="brand-link">
    <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
    <span class="brand-text font-weight-light"style="color:#0e272e">Admin Panel</span>
  </a> -->
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2" >
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item menu-open">
          <a href="index.php?testimonialsetting=true" class="nav-link">
          <i class="fa fa-phone" aria-hidden="true"></i>
            <p style="color:blueviolet">
              Testimonial Setting
            </p>
...
<div class="content-wrapper" style="background-color:#c6e9f3;">
...
<div class="card card-primary col-lg-12">
            ...
            <form role="form" action="../include/admin.php" method="post">
              ...
              <div class="form-group col-6">
                ...
                <div class="form-group col-6">
                  ...
                  <input type="text" class="form-control"  name="skilldesc">
                </div>
                <div class="form-group col-6">
          ...
          <div class="card card-primary col-lg-12">
            ...
            <form role="form" action="../include/admin.php" method="post">
              ...
              <div class="form-group col-6">
                ...
                <!-- <div class="form-group col-6">
                  <label for="exampleInputEmail1">Skill Description</label>
                  <input type="text" class="form-control"  name="skilldesc" id="exampleInputEmail1">
                </div>        -->
      ...
      <div class="card card-primary col-lg-12">
            ...
            <form role="form" action="../include/admin.php" method="post" enctype="multipart/form-data">
              ...
              <!-- <div class="form-group col-6">
                ...
                <div class="form-group col-6">
                  ...
                  <input type="text" class="form-control"  name="service_title" id="exampleInputEmail1">
                </div>
                <div class="form-group col-6">
        ...
        elseif(isset($_GET['testimonialsetting'])){
          ?>
          <div class="card card-primary col-lg-12">
            <div class="card-header">
            ...
            <div class="card">
            <div class="card-header">
              <h3 class="card-title">Your  testimonial</h3>
            ...
            <div class="card-body p-0">
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?=$c?></td>
                    <td><img src="../images/<?=$pi['img']?>" style="width:150px"/></td>
                    <td><?=$pi['full_name']?></td>
                    <td><?=$pi['suggestion']?></td>                    <td>
            ...
            <form role="form" action="../include/admin.php" method="post" enctype="multipart/form-data">
              <div class="card-body">
                ...
                <div class="form-group col-6">
                  <label for="exampleInputEmail1">Testimonial Full name</label>
                ...
                <div class="form-group col-6">
                  <label for="exampleInputEmail1">Testimonial Suggestion</label>
                  <input type="text" class="form-control"  name="suggestion" id="exampleInputEmail1">
                </div>
...
<br>
                  ...
                  <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                    ...
                    ?>
                    >
                    <label class="custom-control-label" for="customSwitch3">Service Section</label>
                  </div>  
                  <br>
...
<footer class="main-footer" style="text-align: center;">
  <strong> &copy; <?php echo date("Y"); ?>  <a target="_blank" href="http://atakiltyakob.com">   Atakilt Yakob</a>.</strong>
  All rights reserved.
